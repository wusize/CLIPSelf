torchrun --nproc_per_node 8 -m training.main_llava --batch-size=32 --lr=1e-5 --wd=0.1 --epochs=6 --workers=4 \
--model='openai/clip-vit-large-patch14-336' --warmup 1000 --dataset-type grid_distill  \
--train-data data/cc3m/cc3m_train_original_size_filtered.json \
--train-image-root="" \
...
--alpha 0.95 --llava --l1-weight 1.0