...
--embed-path metadata/coco_panoptic_clip_hand_craft_EVACLIP_ViTB16.npy --train-image-root data/lvis_v1 \
...
--name clipself_lvis_6_save6_test1_eva_vitb16_12layers --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7